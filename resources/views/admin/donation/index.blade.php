...
<form action="{{ route('donation.delete') }}" method="post">
  ...
  @foreach($donations as $donation)
      <tr>
     <td>
        <input type="checkbox" name="donationsn[]" class="checkboxes" 
        value="{{ $donation->id }}" />
      </td>
    ...
    {!! Form::open(['method' => 'DELETE','url' => 'admin/donation/'. $donation->id,'style'=>'display:inline', ('onclick="return myFunction();"')]) !!}
