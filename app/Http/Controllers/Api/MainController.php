...
private function responseJson($status, $message, $data = null)
{
	...
	public function bloodtype(){
		...
		return $this->responseJson(1, 'success', $blood_type);
	...
	public function donations_form(Request $request){
		...
		$notification = Notification::create(['title'=>'mo', 'content'=> 'f' , 'donation_request_id'=> $donation->id]);//Create Notify
	...
	public function donations_requests(){
		...
		return $this->responseJson(1, 'success', $donations_requests);
	...
	public function reports(Request $request){
		...
		$reports->save();
		return $this->responseJson(1, 'success', $reports);
	...
	public function contacts(Request $request){
		...
		$contacts->save();
		return $this->responseJson(1, 'success', $contacts);
	...
	public function notifications(){
		...
		return $this->responseJson(1, 'success', $notifications);
	...
	public function clients(){
		...
		return $this->responseJson(1, 'success', $clients);
  ...
  public function favouriteArticle(Request $request){
       ...
       $request->user()->favourites()->attach($request->post_id);
   ...
   public function unFavouriteArticle(Request $request){

       $request->user()->favourites()->detach($request->post_id);
   ...
   public function all_favourites(){
       ...
       $favourites = ClientPost::all();

       return $this->responseJson(1 , 'Success' , $favourites);
   }
...

    {
       $settings = Setting::all();
        ...
        return $this->responseJson(1,'loaded',$settings);
    }
