...
////  Favorites
   ...
   Route::get('article_favourite' , 'MainController@favouriteArticle');

   Route::get('article_unFavourite' , 'MainController@unFavouriteArticle');

   Route::get('all_favourites' , 'MainController@all_favourites');
